...
export default function Home(){
    ...
    return(
        <div>
            <div className={`radial-glow aspect-square rounded-full fixed w-[32vw] -top-[14vw] -left-[18vw]`}></div>
            <div className={`radial-glow aspect-square rounded-full fixed w-[25vw] -top-[12vw] -right-[16vw]`}></div>
            <main>
                <Container>
